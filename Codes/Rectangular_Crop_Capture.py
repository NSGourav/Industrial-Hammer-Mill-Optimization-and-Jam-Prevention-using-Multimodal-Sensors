...
x_start, x_end = 300, 1620  # Horizontal range
y_start, y_end = 100, 1000  # Vertical range

def capture_frames():
    """Captures RGB (with rectangular crop), Depth, and PLY files every 5 seconds and saves them locally."""
    try:
        while True:
            ...
            # Apply rectangular crop to RGB image
            cropped_color = color_image[y_start:y_end, x_start:x_end]
            ...
            # Save PLY (full frame, not cropped)
            pc = rs.pointcloud()
